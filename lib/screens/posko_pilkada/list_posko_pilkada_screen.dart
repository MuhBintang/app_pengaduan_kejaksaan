...
import 'package:app_kejaksaan/screens/posko_pilkada/detailPoskoPilkada_screen.dart';
import 'package:app_kejaksaan/screens/posko_pilkada/edit_poskoPilkada_screen.dart';
import 'package:app_kejaksaan/screens/posko_pilkada/p_pilkada_screen.dart';
...
class ListPoskoPilkadaScreen extends StatefulWidget {
  final Datum? data;
  const ListPoskoPilkadaScreen({this.data, super.key});

  @override
  State<ListPoskoPilkadaScreen> createState() => _ListPoskoPilkadaScreenState();
}

class _ListPoskoPilkadaScreenState extends State<ListPoskoPilkadaScreen> {
  ...
  Future<List<Datum>?> getPengaduan() async {
    try {
      ...
      List<Datum> filteredData = data.where((datum) => datum.kategori == "posko pilkada").toList();
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => PoskoPilkadaScreen()),
          );
        },
                              ...
                              return GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => DetailPoskoPilkadaScreen(pengaduan: data),
                                    ),
                                  );
                                },
                                child: Padding(
                                              ...
                                              IconButton(
                                                ...
                                                onPressed: () {
                                                  Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                          builder: (context) =>
                                                              EditPoskoPilkadaScreen(data: data,))
                                                              );
                                                },
                                                icon: Icon(
                                                  Icons.edit,
