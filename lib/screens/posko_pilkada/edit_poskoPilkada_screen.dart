...
class EditPoskoPilkadaScreen extends StatefulWidget {
  final Datum? data;
  const EditPoskoPilkadaScreen({this.data, super.key});

  @override
  State<EditPoskoPilkadaScreen> createState() => _EditPoskoPilkadaScreenState();
}

class _EditPoskoPilkadaScreenState extends State<EditPoskoPilkadaScreen> {
  File? _ktpFilePath;
