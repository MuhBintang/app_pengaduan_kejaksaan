...
import 'package:app_kejaksaan/screens/penyuluhan_hukum/detailPenyuluhan_hukum.dart';
import 'package:app_kejaksaan/screens/penyuluhan_hukum/edit_p_hukum.dart';
import 'package:app_kejaksaan/screens/penyuluhan_hukum/p_hukum_screen.dart';
...
class ListPenyuluhanHukum extends StatefulWidget {
  final Datum? data;
  const ListPenyuluhanHukum({this.data, super.key});

  @override
  State<ListPenyuluhanHukum> createState() => _ListPenyuluhanHukumState();
}

class _ListPenyuluhanHukumState extends State<ListPenyuluhanHukum> {
  ...
  Future<List<Datum>?> getPengaduan() async {
    try {
      ...
      List<Datum> filteredData = data.where((datum) => datum.kategori == "penyuluhan hukum").toList();
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => PenyuluhanHukumScreen()),
          );
        },
                              ...
                              return GestureDetector(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => DetailPenyuluhanHukumScreen(pengaduan: data),
                                    ),
                                  );
                                },
                                child: Padding(
                                              ...
                                              IconButton(
                                                ...
                                                onPressed: () {
                                                  Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                          builder: (context) =>
                                                              EditPenyuluhanHukumScreen(data: data,))
                                                              );
                                                },
                                                icon: Icon(
                                                  Icons.edit,
