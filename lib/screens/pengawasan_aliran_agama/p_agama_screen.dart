...
class PengawasanAgamaScreen extends StatefulWidget {
  const PengawasanAgamaScreen({super.key});

  @override
  State<PengawasanAgamaScreen> createState() => _PengawasanAgamaScreenState();
}

class _PengawasanAgamaScreenState extends State<PengawasanAgamaScreen> {
  File? _ktpFilePath;
  ...
  Future<void> addphkm() async {
    try {
      ...
      if (_ktpFilePath != null && _laporanFilePath != null) {
        ...
        request.fields['kategori'] = "pengawasan aliran dan kepercayaan";
