...
class DetailPengawasanAliranScreen extends StatelessWidget {
  final Datum pengaduan;
  const DetailPengawasanAliranScreen({required this.pengaduan});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Detail Pengawasan Aliran dan Agama'),
      ),
