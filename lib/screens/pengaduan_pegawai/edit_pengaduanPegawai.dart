...
class EditPengaduanPegawaiScreen extends StatefulWidget {
  final Datum data;
  const EditPengaduanPegawaiScreen(this.data ,{super.key});

  @override
  State<EditPengaduanPegawaiScreen> createState() => _EditPengaduanPegawaiScreenState();
}

class _EditPengaduanPegawaiScreenState extends State<EditPengaduanPegawaiScreen> {
  File? _ktpFilePath;
